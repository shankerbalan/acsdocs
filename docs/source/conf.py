# -*- coding: utf-8 -*-
#
# CloudStack Documentation documentation build configuration file, created by
...
project = u'CloudStack Documentation'
copyright = u'2013, Apache CloudStack'
...
htmlhelp_basename = 'CloudStackDocumentationdoc'
...
epub_title = u'CloudStack Documentation'
epub_author = u'Apache CloudStack'
epub_publisher = u'Apache CloudStack'
epub_copyright = u'2013, Apache CloudStack'
